...
#tentative d'implémenter une moyenne sur les prédictions pour tous les visages. -Ne repère plus qu'un visage à la fois?
...
while 1:
    ...
    for index,(x,y,w,h) in enumerate(faces):
        ...
        #predictions[predictionIndex]=preds
        #print (visageIndex, len(visages),visages)
