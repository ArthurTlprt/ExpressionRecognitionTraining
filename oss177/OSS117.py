...
#    for j in range(np.shape(np_putin1)[1]):
#        if np_putin1[i][j][3] ==0:
#            pass
#        elif (i<np.shape(np_putin1)[0]) and (j<np.shape(np_putin1)[1]):
#            vladTransparencyLeft.append([j,i])
#for i in range(np.shape(np_putin1)[0]):
#    for j in range(np.shape(np_putin1)[1]):
#        if np_putin1[i][np.shape(np_putin1)[1]-j-1][3] ==0:
#            pass
#        elif (i>0) and (j>0):
