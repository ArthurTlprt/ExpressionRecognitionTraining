...
for name in names:
    f = h5py.File('/media/isen/Data_windows/PROJET_M1_DL/Affect-Net/MAN/classes227/Shuffled227/training' + name + '.hdf5', 'r')
    h5.append(np.copy(f['data'][:10000]))
    f.close()
...
mio.export_image(mi.Image(mean_image), "/media/isen/Data_windows/PROJET_M1_DL/Affect-Net/MAN/classes227/mean_image.png", overwrite=True)
...
mio.export_image(mi.Image(std_image), "/media/isen/Data_windows/PROJET_M1_DL/Affect-Net/MAN/classes227/std_image.png", overwrite=True)


print('saving in h5 file')
g = h5py.File("/media/isen/Data_windows/PROJET_M1_DL/Affect-Net/MAN/classes227/mean_std.hdf5", "w")
