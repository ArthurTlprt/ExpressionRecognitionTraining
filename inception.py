...
def generate_arrays_from_file(path, batch_size=32, shuffle=True):
    global images, annotations, names, mean_image, std_image
...
def inception_resnet_v2():
	...
	#model.compile(optimizer='adam',loss={'normalized_mse': normalized_mse})
	return model
...
#x = inception_resnet_v2_a(x)
#x = inception_resnet_v2_reduction_a(x)
#x = inception_resnet_v2_b(x, scale=0.1)
#x = inception_resnet_v2_reduction_b(x)
#x = inception_resnet_v2_c(x, scale=0.2)
